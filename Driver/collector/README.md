...
explicitly selected rollback path in case a LinkedIn UI change makes the
Playwright collector unusable. It is invoked by `collectorMode=agent` and must
not be read in other modes.
